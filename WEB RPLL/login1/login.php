...
<div class="row">
	...
	<div class="carousel" id="carousel">
		<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				...
				<div class="carousel-item animate__animated animate__slideInRight" style="margin-top: -119px;">
					<img id="carousel2" src="carousel2.jpg" class="d-block w-100" alt="..." style="height:100%; width:auto;";>
					<div class="carousel-caption">
						<h1 class="display-4 animate__animated animate__fadeInUp" id="carouselh12">Our website provides module for any subject in any grade</h1>
					</div>
				</div>
				<div class="carousel-item animate__animated animate__slideInRight" style="margin-top: -119px;">
					<img id="carousel3" src="carousel3.jpg" class="d-block w-100" alt="..." style="height:100%; width:auto;";>
					<div class="carousel-caption">
	...
	<div class="login">
		...
		<h1 style="margin: 10px;color: white; padding-bottom:20px;">Login</h1>
